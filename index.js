...
// })
// app.get('/lista2/ex1', (req, res) => {
//     const {nome,horasTrabalhadas,valorPorHora,filhos} = req.body

//     const salarioBruto = horasTrabalhadas * valorPorHora
//     const bonificacaoPorFilhos= 0.03 * salarioBruto * filhos
//     const salarioFinal = salarioBruto + bonificacaoPorFilhos

//     res.send(`Seu nome e ${nome}\nSeu salario bruto e ${salarioBruto}\nSeu bonus por filhos e ${bonificacaoPorFilhos}\nSeu salario final e ${salarioFinal}`)
//     res.json({
//         salarioBruto: salarioBruto, bonificacaoPorFilhos: bonificacaoPorFilhos, salarioFinal: salarioFinal
//     })
// })
// app.get('/lista2/ex2', (req, res) => {
//     res.send('Hello Alisson! Ola Alhkhdsfsisson!');
// })
// app.get('/lista2/ex3', (req, res) => {
//     res.send('Hello Alisson! Ola Alhkhdsfsisson!');
// })
// app.get('/lista2/ex4', (req, res) => {
//     res.send('Hello Alisson! Ola Alhkhdsfsisson!');
// })
// app.get('/lista2/ex5', (req, res) => {
//     res.send('Hello Alisson! Ola Alhkhdsfsisson!');
// })
// app.get('/lista2/ex6', (req, res) => {
//     res.send('Hello Alisson! Ola Alhkhdsfsisson!');
// })
// app.get('/lista2/ex7', (req, res) => {
//     res.send('Hello Alisson! Ola Alhkhdsfsisson!');
// })
// app.get('/lista2/ex8', (req, res) => {
//     res.send('Hello Alisson! Ola Alhkhdsfsisson!');
// })
// app.get('/lista2/ex9', (req, res) => {
//     res.send('Hello Alisson! Ola Alhkhdsfsisson!');
// })
